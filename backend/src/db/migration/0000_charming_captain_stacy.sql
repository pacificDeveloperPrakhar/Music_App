...
CREATE TABLE "user" (
	...
	"theme" varchar DEFAULT '',
	"uri" text,
	"permisson" "permissons" DEFAULT 'user',
...
ALTER TABLE "artistSong" ADD CONSTRAINT "artistSong_artist_id_artist_id_fk" FOREIGN KEY ("artist_id") REFERENCES "public"."artist"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "artistSong" ADD CONSTRAINT "artistSong_audio_id_audio_id_fk" FOREIGN KEY ("audio_id") REFERENCES "public"."audio"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "playlist_songs" ADD CONSTRAINT "playlist_songs_added_by_user_id_fk" FOREIGN KEY ("added_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
